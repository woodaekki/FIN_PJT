...
짧은 프로젝트 기간에 비해 요구사항이 많았기에 개인적으로 코드 개선 및 재작성하여 다시 완성한 프로젝트 입니다.
특정 연령층을 타겟팅한 사이트를 만들어 더욱 매력있는 프로젝트를 만들지 못한 아쉬움은 여전히 남지만, 
python부터 django, javascript, vue까지 한 학기동안 배운 기술들을 활용하여 
