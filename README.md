...
상성 SW 아카데미의 1학기에 진행한 관통 프로젝트를 개인적으로 코드 개선 및 재작성하여 다시 완성한 프로젝트 입니다. 짧은 프로젝트 기간에 비해 요구사항이 많았기에, 특정 연령층을 타겟팅한 사이트를 만들거나 제시된 요구사항을 더욱 커스텀하는 등 더욱 매력있는 프로젝트를 만들지 못한 아쉬움은 여전히 남지만, python부터 django, javascript, vue까지 한 학기동안 배운 기술들을 활용하여 프로젝트를 완성해내다니 스스로의 성장이 느껴져 뿌듯합니다.
